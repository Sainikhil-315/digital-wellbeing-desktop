...
function heatmapColor(secs) {
  ...
  if (secs < 300)   return 'rgba(99,102,241,0.18)'
  if (secs < 900)   return 'rgba(99,102,241,0.38)'
  if (secs < 1800)  return 'rgba(99,102,241,0.62)'
  if (secs < 3600)  return 'rgba(99,102,241,0.84)'
  return '#6366F1'
}
